export const AUDIT_ACTIONS = {
  ...
  USER_TRAINING_PAUSED: "USER_TRAINING_PAUSED",
  USER_TRAINING_REACTIVATED: "USER_TRAINING_REACTIVATED",
  DRILL_CREATED: "DRILL_CREATED",
  DRILL_UPDATED: "DRILL_UPDATED",
  DRILL_SENT: "DRILL_SENT",
  DRILL_SEND_FAILED: "DRILL_SEND_FAILED",
...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  USER_TRAINING_PAUSED: "Training paused",
  USER_TRAINING_REACTIVATED: "Training reactivated",
  DRILL_CREATED: "Drill created",
  DRILL_UPDATED: "Drill updated",
  DRILL_SENT: "Drill sent",
  DRILL_SEND_FAILED: "Drill send failed",
...
export const AUDIT_CATEGORIES = [
  ...
  },
  {
    id: "users",
    label: "Users",
    actions: ["USER_PASSWORD_RESET", "USER_DISABLED", "USER_REACTIVATED", "USER_DELETED", "USER_TRAINING_PAUSED", "USER_TRAINING_REACTIVATED", "WELCOME_EMAIL_SENT", "ADMIN_PASSWORD_RESET_EMAIL_SENT", "ADMIN_USER_EMAIL_CHANGED"],
  },
  {
    id: "platform",
    label: "Platform",
    actions: ["DRILL_CREATED", "DRILL_UPDATED", "DRILL_SENT", "DRILL_SEND_FAILED", "CONTENT_CREATED", "CONTENT_UPDATED", "CONTENT_DELETED", "PLATFORM_SETTING_CHANGED", "EMAIL_TEST_SENT"],
  },
] as const;
