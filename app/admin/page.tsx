...
type AdminTab = "overview" | "users" | "drills" | "templates" | "content";
...
export default function AdminPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-8">
      <div className="rounded-xl border border-gold/40 bg-gold/15 px-4 py-2.5 mb-5 flex items-start gap-2.5 text-sm text-navy/80">
        <AlertTriangle size={16} className="text-coral-dark shrink-0 mt-0.5" />
        <p>
          <strong className="font-bold text-navy">Development reminder:</strong> Admin access
          control is not enabled yet. Do not use with real user data.
        </p>
      </div>
          ...
          {(activeTab === "overview" || activeTab === "users") && stats && (
            <section className="mb-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-2">
                <AdminKpiCard label="Total users" value={stats.totalUsers} />
                <AdminKpiCard label="Active users" value={stats.activeUsers} />
